...
public final class ModKeys {
    ...
    public static final KeyMapping BTN_R = key("btn_r", GLFW.GLFW_KEY_E);
    public static final KeyMapping BTN_L2 = key("btn_l2", GLFW.GLFW_KEY_1);
    public static final KeyMapping BTN_R2 = key("btn_r2", GLFW.GLFW_KEY_2);
    ...
    // Right analog stick (numpad)
    public static final KeyMapping ANALOG_RIGHT_UP = key("analog_right_up", GLFW.GLFW_KEY_KP_8);
    public static final KeyMapping ANALOG_RIGHT_DOWN = key("analog_right_down", GLFW.GLFW_KEY_KP_5);
    public static final KeyMapping ANALOG_RIGHT_LEFT = key("analog_right_left", GLFW.GLFW_KEY_KP_4);
    public static final KeyMapping ANALOG_RIGHT_RIGHT = key("analog_right_right", GLFW.GLFW_KEY_KP_6);
    ...
    public static void registerKeys(RegisterKeyMappingsEvent event) {
        event.register(DPAD_UP); event.register(DPAD_DOWN);
        event.register(DPAD_LEFT); event.register(DPAD_RIGHT);
        event.register(BTN_A); event.register(BTN_B);
        event.register(BTN_X); event.register(BTN_Y);
        event.register(BTN_L); event.register(BTN_R);
        event.register(BTN_L2); event.register(BTN_R2);
        event.register(BTN_START); event.register(BTN_SELECT);
        event.register(ANALOG_LEFT_UP); event.register(ANALOG_LEFT_DOWN);
        event.register(ANALOG_LEFT_LEFT); event.register(ANALOG_LEFT_RIGHT);
        event.register(ANALOG_RIGHT_UP); event.register(ANALOG_RIGHT_DOWN);
        event.register(ANALOG_RIGHT_LEFT); event.register(ANALOG_RIGHT_RIGHT);
    }

    public static boolean isKeyDown(KeyMapping key) {
        long window = net.minecraft.client.Minecraft.getInstance().getWindow().getWindow();
        return GLFW.glfwGetKey(window, key.getKey().getValue()) == GLFW.GLFW_PRESS;
    }
